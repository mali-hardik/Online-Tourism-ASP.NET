<%@ Page Title="" Language="C#" MasterPageFile="~/user/destination.master" AutoEventWireup="true" CodeFile="destination_subcategory.aspx.cs" Inherits="user_Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [Package] WHERE ([pack_type_id] = @pack_type_id) and status = '1'">
        <SelectParameters>
            <asp:QueryStringParameter Name="pack_type_id" QueryStringField="pack_type_id" 
                Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
